package com.selenium.newheading.utility;
...
public class NewsHeading extends BaseClass {

    @FindBy(css = "a.storylink")
    List<WebElement> newsElements;

    @FindBy(css = "tr td span.score")
    List<WebElement> pointsElements;

    public NewsHeading(WebDriver driver) {
        PageFactory.initElements(driver, this);
    }

    public void new_headings() {
        List<String> newsHeadingList = new ArrayList<>();
        List<Integer> pointsList = new ArrayList<>();

       //used for loop for getting news on the console
        for (WebElement webElementHeader : newsElements) {

            System.out.println(webElementHeader.getText());
            newsHeadingList.add(webElementHeader.getText());
        }

       //used for loop for getting points on the console
        for (WebElement webElementPoints : pointsElements) {
        ...
        Iterator<String> newsIterator = newsHeadingList.iterator();
        ...
        List<String> wordList = listOfWords(newsHeadingList);
